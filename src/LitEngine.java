...
public class LitEngine{
    ...
    public static synchronized void start(String type) throws InterruptedException {
        ...
        // Set font
       // frame.setFont(null);
       // pixelFrame.setFont(new Font("Courier", Font.PLAIN, 12));
        // This is now done in the html part.
    ...
    public static void render(){
        ...
        String print = "<html><pre><span style='color:white; font-family: Liberation Mono; font-size: 10.3px; font-style: normal; font-variant: normal; font-weight: 500; line-height: 26.4px;'>";
